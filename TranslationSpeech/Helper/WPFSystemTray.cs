...
namespace TranslationSpeech.Helper
{
    public class WPFSystemTray
    {
        ...
        public static NotifyIcon SetSystemTray(SystemTrayParameter pars, List<SystemTrayMenu> menuList)
        {
            ...
            notifyIcon.Icon = Resources.planet_earth_128px_1202602_easyicon_net;
    ...
    {
        public SystemTrayParameter( string MinText, string TipText, int Time, MouseEventHandler dbClick)
        {
